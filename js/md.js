    ...
    section2Fn: function () {
      $.ajax({
        ...
        success: function (rData) {
          ...
          let str = "";
          $.each(rData.md, function (idx, data) {
            ...
            $(this).on({
              click: function (e) {
                ...
                $.get(
                  ...
                  function (d) {
                    // console.log(d);
                    // console.log(d.md[1].idx);
                    // console.log(d.md.length);

                    for (let i = 0; i < d.md.length; i++) {
                      if (d.md[i].idx == id) {
                        // console.log(d.md[i].krTitle);
                        let data = d.md[i];
