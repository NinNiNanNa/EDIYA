(function ($, window, document, undefined) {
  var drink = {
    ...
    section2Fn: function () {
      $.ajax({
        ...
        success: function (rData) {
          ...
          let str = "";
          $.each(rData.drink, function (idx, data) {
            ...
            $(this).on({
              click: function (e) {
                ...
                $.get("/json/menu.json", function (d) {
                  // console.log(d);
                  // console.log(d.drink[1].idx);
                  // console.log(d.drink.length);

                  for (let i = 0; i < d.drink.length; i++) {
                    if (d.drink[i].idx == id) {
                      // console.log(d.drink[i].krTitle);
                      let data = d.drink[i];
    ...
    section4Fn: function () {
      let dataCount = 0; // drink의 전체 데이터 갯수
      ...
      $.ajax({
        ...
        dataType: "json",
        success: function (rData) {
          // console.log(rData.drink);
          let data = rData.drink;
